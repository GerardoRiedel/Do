    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bhoechie-tab-container" >
                ...
                <a href="<?php echo base_url("do/mantenedores/cargarModalidad/")?>" style="color: #da812e; font-size: 30px; padding-top: -30px;margin-top:-30px;margin-bottom: 5px;margin-left: 25px" title="Agregar Cargo"><i class="fa fa-plus" aria-hidden="true"></i></a>
                <table class='table table-bordered table-hover table-striped data-table'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $item->modId; ?></td>
                                <td><?php echo $item->modNombre; ?></td>
                                <td align="center">
                                    <a class="tip-bottom" title="Modificar Motivo" href="<?php echo base_url("do/mantenedores/cargarModalidad/".$item->modId )?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
