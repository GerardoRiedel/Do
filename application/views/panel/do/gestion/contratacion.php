                ...
                <!-- DATOS DE PERSONALES-->     
                    ...
                    <div class='col-lg-4'>
                        <table>
                            <tbody>
                            <tr>
                                <td style=" width: 30px" align="center"><input type="radio" name="empresa" value="1" <?php IF(!empty($contratacion->conEmpresa) && $contratacion->conEmpresa === '1')echo 'checked'; ?>></td>
                    ...
                    <div class='col-lg-4'>
                        <select name="motivo" id="motivo">
                            ...
                            <?php foreach($motivo as $mot): ?>
                                <option value="<?php echo $mot->motId;?>" <?php IF(!empty($contratacion->conMotivo) && $contratacion->conMotivo === $mot->motId)echo 'selected'; ?> ><?php echo $mot->motNombre;?></option>
                            <?php endforeach; ?>
                        </select> 
                    </div>
                    <div class="col-lg-1">
                    ...
                    <div class="col-lg-1"></div>
                    <div class="col-lg-3">
                        <label>Perfil de Cargo (Descriptor)</label>
                    </div>
                    <div class='col-lg-4'>
                        <table>
                            <tbody>
                    ...
                    <div class='col-lg-6'>
                        <textarea name="observacion" style=" width: 100%; height:60px" placeholder="Indique alguna observación extra, experiencia requerida u otro requisito" ><?php IF(!empty($contratacion->conObservacion))echo $contratacion->conObservacion; ?></textarea>
                    </div>
                    ...
                    <div class="col-lg-10">
                        <table >
                            <tr>
                                <td style="width:300px"><label>Materiales Requeridos</label></td>
                                <td style="width:50px"></td>
                                <td style="width:300px"><label>Entrega de Uniforme</label></td>
                            </tr>
                            <tr>
                    ...
                    <div class='col-lg-6'>
                        <input  type="text"name="sueldo" placeholder="Ingrese rango de sueldo" value="<?php IF(!empty($contratacion->conSueldo))echo $contratacion->conSueldo; ?>">
                    </div>
                    <?php } ELSE { ?>
                    <div class="col-lg-12"><hr></div>
                    <div class="col-lg-12" ><br>
                    ...
                    <div class='col-lg-6'>
                        <input  type="text"name="sueldo" readonly="true" placeholder="Ingrese rango de sueldo" value="<?php IF(!empty($contratacion->conSueldo))echo $contratacion->conSueldo; ?>">
                    </div>
                    <?php } ?>
...
$(document).ready(function(){
    ...
    $("#cargomostrar").mouseover(function(){
        ...
        if($("#motivo").val()==='5' || $("#motivo").val()==='6' || $("#motivo").val()==='7') { 
            $("#divPeriodo").show();
        }
...
$("#form").submit(function () { 
    ...
    if($("#modalidad").val()==='0') {   $("#iconModalidad").show();   }
     ...
     if($("#motivo").val()==='5' || $("#motivo").val()==='6' || $("#motivo").val()==='7') { 
            ...
            if($("#periodo").val()===''){return false; }
            if($("#colaborador").val()==='0'){return false;}
    }
    if($("#cargo").val()==='1000') {
          if($("#otroCargo").val()===''){
            return false;
